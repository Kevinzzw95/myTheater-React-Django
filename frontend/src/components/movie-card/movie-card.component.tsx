    ...
    return (
        <div className="card">
            <div className="group relative">
                <img className="rounded-lg opacity-90 group-hover:opacity-70" src={require("../../assets/pokemon.jpg")}/>
                <div className="absolute box rounded-lg w-16 h-8 bg-accent top-2 left-2 flex items-stretch">
                    ...
                    <h1 className="text-white text-lg self-center">7.6</h1>
                </div>
                <label htmlFor="my-modal" className="absolute inset-x-10 bottom-5 btn btn-primary align-middle opacity-0 group-hover:opacity-100">
										Details									
                </label>
            ...
            <h1 className="text-xl text-primary-content">{ movie.name }</h1>
            <div className="flex">
